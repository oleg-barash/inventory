...
class ItemRow extends Component {
    ...
    render() {
        ...
        if (actions != undefined){
            ...
            priceValue = item.Price != undefined && (item.Count != undefined || totalFact != undefined) ? item.Price * totalFact + '/' + item.Price * item.Count + '(' + reitemsts.Price * (totalFact - item.Count) + ')' : '-';
        }
        return (
